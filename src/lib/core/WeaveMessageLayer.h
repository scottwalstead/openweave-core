...
public:
    ...
    void *mRepairCtxt;                                  /**< A pointer to an application-specific context object used for repair info retrieval. */
 ...
 */
    ...
    ConnectionRepairInfoGetterFunct GetConnectionRepairInfo;


    WEAVE_ERROR TryRepairConnection(uint64_t peerNodeId, IPAddress destAddr = IPAddress::Any,
                                    uint16_t destPort = WEAVE_PORT, InterfaceId intf = INET_NULL_INTERFACEID);
#endif // WEAVE_CONFIG_TCP_CONN_REPAIR_SUPPORTED
